        ...
        <div class="row">
            <div class="col-md-12 ">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br />
                        <form action="{{route('createBlog')}}" method="POST" enctype="multipart/form-data" class="form-horizontal form-label-left">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9 col-sm-9 ">
                                    <select class="select2_single form-control" id="blog_category" name="blog_category" required tabindex="-1">
                                        <option></option>
                            ...
                            <div class="control-group row">
                                ...
                                <div class="col-md-9 col-sm-9 ">
                                    <input id="blog_tags" name="blog_tags" required type="text" class="tags form-control" />
                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <textarea id="summernote" class="summernote" name="content" required></textarea>
