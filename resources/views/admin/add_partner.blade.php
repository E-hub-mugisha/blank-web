        ...
        <div class="row">
            <div class="col-md-12 ">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br />
                        <form action="{{route('createPartner')}}" method="POST" enctype="multipart/form-data" class="form-horizontal form-label-left">
                            @csrf

                            <div class="form-group row ">
                                <label class="control-label col-md-3 col-sm-3 ">Names</label>
                                <div class="col-md-9 col-sm-9 ">
                                    <input type="text" class="form-control" id="partner_name" name="partner_name" required placeholder="enter partner names">
