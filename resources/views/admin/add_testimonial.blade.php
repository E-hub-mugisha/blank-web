        ...
        <div class="row">
            <div class="col-md-12 ">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br />
                        <form action="{{route('createTestimonial')}}" method="POST" enctype="multipart/form-data" class="form-horizontal form-label-left">
                            @csrf
                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <textarea id="summernote" class="summernote" name="review" required></textarea>
